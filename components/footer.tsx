    ...
    <footer className="bg-primary py-12 text-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-8 grid gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <Link href="#" className="flex h-10 w-10 items-center justify-center rounded-lg bg-white/10 transition-colors hover:bg-white/20">
        ...
        <div className="flex items-center justify-between border-t border-white/20 pt-8 text-sm opacity-80">
          ...
          <Link href="/admin" className="text-xs text-transparent select-none cursor-default">
            관리자
          </Link>
        </div>
      </div>
