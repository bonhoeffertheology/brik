      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-8 grid gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <p className="mb-2 text-sm leading-relaxed opacity-80">서울시 마포구 잔다리로 6길 12, 501호</p>
            <p className="text-sm leading-relaxed opacity-80">
              501, 12, Jandari-ro 6-gil, Mapo-gu, Seoul, Republic of Korea
            </p>
          </div>
        ...
        <div className="flex items-center justify-between border-t border-white/20 pt-8 text-sm opacity-80">
          ...
          <Link href="/admin" className="text-xs opacity-50 transition-opacity hover:opacity-100">
            관리자
          </Link>
        </div>
      </div>
