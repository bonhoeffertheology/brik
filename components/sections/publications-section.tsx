...
export function PublicationsSection() {
  ...
  return (
    ...
    >
      ...
      {/* 연구업적(Research) 섹션의 검증된 쉬머 키프레임과 클래스 그대로 반영 */}
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          {/* 연구활동 섹션과 정확히 동일한 골드 옐로우 빛줄기 가변 바(Bar) */}
            ...
            {books.map((book, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    {/* 직사각형(모서리 각진 형태) 구현 */}
                    <div className="relative h-full w-auto overflow-hidden shadow-xl">
                      <img
                        src={book.imageSrc}
                        alt={book.title}
                      ...
                      {/* 음영막이 아래에 대기하다가 위로(translate-y-full -> translate-y-0) 롤업되는 구조 */}
                      <div 
