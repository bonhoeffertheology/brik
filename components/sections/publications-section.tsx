          ...
          {books.map((book, i) => {
           ...
           return (
              ...
              >
                ...
                {/* 아래 줄 추가: 안내 문구 */}
        <div className={`transition-opacity duration-700 delay-500 ease-in-out ${isCenter ? "opacity-100" : "opacity-0"}`}>
                  <p className="mt-8 text-stone-400 text-[10px] md:text-xs text-center font-sans">
